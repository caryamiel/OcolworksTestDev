...
ActiveRecord::Schema.define(version: 20160205210323) do
  ...
  create_table "subtasks", force: :cascade do |t|
    ...
    t.datetime "updated_at",           null: false
    t.integer  "task_id"
    t.string   "subtask_confirmation"
  end

  create_table "talkresps", force: :cascade do |t|
    t.integer  "user_id"
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.string   "task_confirmation"
    t.string   "task_prerequisite"
  end
